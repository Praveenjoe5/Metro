...
span{
  ...
  <header>
       ...
       <br><br><br><br>
        ...
        if(((String)request.getAttribute("result")).equalsIgnoreCase("INVALID ID"))
                       {
            out.println("INVALID BOOKING ID <BR>PLEASE ENTER THE CORRECT BOOKING ID");
        }
               else if(((String)request.getAttribute("result")).equalsIgnoreCase("PAYMENT INVALID"))
                                     {
                     out.println("PAYMENT UNSUCCESSFUL DUE TO INVALID CREDENTIALS");
               }
